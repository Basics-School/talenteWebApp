...
const InfoSection = () => {
  return (
    <Box className="flex flex-col lg:!gap-10 !gap-8 !mx-auto !text-center items-center">
      ...
      <GradientText className="Spartan-SemiBold xl:!text-[60px] xl:!leading-[4.7rem] lg:!text-5xl  lg:!leading-[3.7rem] sm:!text-4xl md:!leading-[3.2rem] !text-[25px] !text-center overflow-wrap break-words">
