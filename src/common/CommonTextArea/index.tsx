  ...
  return (
    <Box className="!text-center md:!mt-5">
      ...
      <Box
        ...
        className="max-h-[460px] m-auto my-4 md:my-6 h-1 bg-gradient-to-r from-black via-[#5E17EB8F] to-[#5E17EB8F] xl:max-w-[300px] lg:max-w-[250px] md:!max-w-[170px] !max-w-[125px]"
      />
      <Box
