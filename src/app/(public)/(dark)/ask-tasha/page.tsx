        ...
        >
          ...
          <Container className=" sm:!justify-between sm:!flex lg:!mt-0 sm:!mb-0 !mb-32">
            <Grid container>
                ...
                <Box className="max-w-full sm:max-w-lg relative z-30 flex justify-center">
                  ...
                  >
                    <Stack direction="column">
                      <Typography className="Spartan-SemiBold text-gradient1 text-[var(--white-text)] sm:!text-4xl md:!text-5xl lg:!text-6xl !text-4xl">
                        Tired of
                      </Typography>
                      <Typography className="Spartan-SemiBold text-gradient1 text-[var(--white-text)] sm:!text-4xl md:!text-5xl lg:!text-6xl !mb-1 !text-4xl">
                        company-centric
                      </Typography>
                      <Typography className="Spartan-SemiBold text-gradient1 text-[var(--white-text)] sm:!text-4xl md:!text-5xl lg:!text-6xl !mb-1 !text-4xl">
                        HR Support?
              ...
              <Grid xs={12} md={8}>
                <Box className="flex justify-center items-center w-auto">
                  <Image
                    src={TashaChat}
                    alt="Tasha image for Tasha page"
                    className="z-20 lg:!w-[750px] h-[400px] object-contain object-bottom md:!w-[600px] sm:!w-[500px] !w-[400px] bottom-0 !absolute"
                  />
                </Box>
              </Grid>
            </Grid>
